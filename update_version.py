...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright Add9Sus4, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/AudioComponents-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioComponents-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioComponents-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioComponents-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioComponents-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AudioComponents-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/AudioComponents-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/AudioComponents.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AudioComponents.iss",inplace=1):
